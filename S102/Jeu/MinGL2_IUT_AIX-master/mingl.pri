macos:LIBS += -lglut -lsfml-audio
LIBS += -L"/amuhome/C21201897/opt/SFML/lib/x86_64-linux-gnu" -lglut -lsfml-system -lsfml-audio
!macos:LIBS += -lGLU -lGL

INCLUDEPATH += $$PWD/include/ "/amuhome/C21201897/opt/SFML/include/"
macos:INCLUDEPATH += $$PWD/include/
